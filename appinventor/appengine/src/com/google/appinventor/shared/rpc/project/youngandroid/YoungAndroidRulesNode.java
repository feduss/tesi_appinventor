 ...
 *
 */
public final class YoungAndroidRulesNode extends YoungAndroidSourceNode {
   ...
   */
  public YoungAndroidRulesNode(String fileId) {
    super(StorageUtil.basename(fileId), fileId);
  }

  public static String getRulelyFileId(String qualifiedName) {
