 ...
 */
public class RulelyPanel extends HTMLPanel {

  public interface RulelySource extends JsniBundle {
  ...
  static {
    ((RulelySource) GWT.create(RulelySource.class))
   ...
   *
   */
  public interface RulelyWorkspaceChangeListener {
    /**
   ...
   */
  private final Set<RulelyWorkspaceChangeListener> listeners = Sets.newHashSet();
  ...
  public RulelyPanel(YaRulesEditor rulesEditor, String formName) {
    this(rulesEditor, formName, false);
  }

  public RulelyPanel(YaRulesEditor rulesEditor, String formName, boolean readOnly) {
    super("");
     ...
     */
    initWorkspace(Long.toString(rulesEditor.getProjectId()), readOnly, LocaleInfo.getCurrentLocale().isRTL());
   ...
   * @param listener
   */
  public void addChangeListener(RulelyWorkspaceChangeListener listener) {
   ...
   * @param listener
   */
  public void removeChangeListener(RulelyWorkspaceChangeListener listener) {
  ...
  private void workspaceChanged(JavaScriptObject event) {
    ...
    if (loadError) {
      ...
      for (RulelyWorkspaceChangeListener listener : listeners) {
  ...
  public static void switchWarningVisibility() {
    if (RulelyPanel.isWarningVisible) {
      RulelyPanel.isWarningVisible = false;
    } else {
      RulelyPanel.isWarningVisible = true;
    }
  }
