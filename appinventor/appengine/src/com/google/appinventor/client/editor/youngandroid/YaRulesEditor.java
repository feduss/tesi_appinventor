...
import com.google.appinventor.shared.rpc.project.youngandroid.YoungAndroidRulesNode;
 ...
 */
public final class YaRulesEditor extends FileEditor
        implements FormChangeListener, BlockDrawerSelectionListener, ComponentDatabaseChangeListener, RulelyPanel.RulelyWorkspaceChangeListener {
  ...
  private static final Map<String, YaRulesEditor> formToRulesEditor = Maps.newHashMap();

  // projectid_formname for this blocks editor. Our index into the static formToBlocksEditor map.
  private String fullFormName;

  private final YoungAndroidRulesNode blocksNode;
  ...
  private final RulelyPanel blocksArea;
  ...
  YaRulesEditor(YaProjectEditor projectEditor, YoungAndroidRulesNode blocksNode) {
    ...
    formToRulesEditor.put(fullFormName, this);
    blocksArea = new RulelyPanel(this, fullFormName); // [lyn, 2014/10/28] pass in editor so can extract form json from it
    ...
    //feduss, nascosta blocks area, perchè l'utente non deve vedere i puzzle
    ...
    OdeAsyncCallback<ChecksumedLoadFile> callback = new OdeAsyncCallback<ChecksumedLoadFile>(MESSAGES.loadError()) {
      ...
      public void onSuccess(ChecksumedLoadFile result) {
        ...
        try {
          ...
          blocksArea.addChangeListener(YaRulesEditor.this);
  ...
  public void onClose() {
    ...
    formToRulesEditor.remove(fullFormName);
  }

  public static void toggleWarning() {
    BlocklyPanel.switchWarningVisibility();
    for(YaRulesEditor editor : formToRulesEditor.values()){
  ...
  @Override
  public void onWorkspaceChange(RulelyPanel panel, JavaScriptObject event) {
...
//    blocksArea.saveBackpackContents();
  ...
  public static String getComponentInstanceTypeName(String formName, String instanceName) {
    ...
    YaRulesEditor rulesEditor = formToRulesEditor.get(formName);
    //get type name from form editor
    return rulesEditor.myFormEditor.getComponentInstanceTypeName(instanceName);
  }

  public static String getComponentInstancePropertyValue(String formName, String instanceName, String propertyName){
    //use form name to get blocks editor
    YaRulesEditor rulesEditor = formToRulesEditor.get(formName);
    Map<String, MockComponent> componentMap = rulesEditor.myFormEditor.getComponents();
  ...
  public static void setBlocksDamaged(String formName) {
    YaRulesEditor editor = formToRulesEditor.get(formName);
    if (editor != null) {
